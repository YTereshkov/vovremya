...
function WorkingHoursForm({ specialist }: { specialist: Specialist }) {
  ...
  return <WorkforceFrame title="Рабочие часы" back={`/specialists/${specialist.id}`}>
    <div className="mb-8 flex items-center gap-3"><Avatar name={specialist.name} /><p className="min-w-0 break-words">{specialist.name} · <span className="text-primary">{specialist.specialization}</span></p></div>
